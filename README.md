...
PYTHONUTF8=1 python -m sim.run_tests            # 全套测试(全绿;套数以输出为准)
...
sim/        run_tests(总跑·全套) · smoke · seed(demo 播种)
