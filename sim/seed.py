...
""")
    ...
    forge.entity_commit(World_w1, "ye-wudao", "叶无道", role="main", from_codex=["cold-protector"], body="""# 叶无道

> 实体 id:`ye-wudao` ｜ 戏份:main
...
- 把人挡在身后,是他唯一不肯改的毛病。
- 不伤无辜——哪怕规则逼他。
- 信过的人背叛过他,所以他再不肯先开口信谁。

## 声音指纹
话短,常以"啧"开头。说狠话时反而轻。从不解释自己为什么救人。

## 核心欲望与底线
想登顶改写那一夜——但他嘴上只说"先活过这一层"。底线:绝不拿同伴当代价。
...
## 身份
跟着叶无道一起被卷进塔的女孩,看似柔弱,记性好得可怕,能背下整面墙的规则。
...
""")
    ...
    forge.thread_commit(World_w1, "first-climb", "首登", genre="无限流", prompt="叶无道与林晚的第一次攀登",
...
## 大纲
α 悬念:把叶无道捅进塔的"背后那一刀"到底是谁。
- 第一层:矛盾规则,叶无道靠悖论破局,林晚第一次有用。
- 第二层:代价律逼他选,他护住了林晚。
- (待写)第七层裂隙:临江漏进来。
""")
...
林晚倒抽一口冷气,后退半步撞进叶无道怀里。叶无道没看那摊东西,只盯着墙。他盯了很久,久到林晚以为他也要犯傻。

"啧。"他终于开口,声音很轻,"两条规则打架,塔就是在告诉你——别信墙,信夹缝。"
...
叶无道顺着她指的方向蹲下去,指腹擦过那行细小的字:**背对门,门自开。**

他没多问她怎么看出来的,只是反手把她拢到身后,自己背过身去,一步步倒退着走向那扇门。门在他背后,悄无声息地,向上裂开了一道缝。

冷风从缝里灌进来,带着上一层的味道。叶无道回头看了林晚一眼,那一眼里没有夸奖,只有一句没说出口的话:跟紧点。
...
叶无道站在镜子前没动。他知道这一层的题在哪——回廊尽头有东西在等他们,凭他现在的伤,正面撑不过去。借力,就能赢;可"最在乎的东西",此刻就站在他半步之后,正用力攥着他的衣角。

"我来。"林晚先开了口,"我没什么可被收走的,我借——"

"闭嘴。"

他打断得很快,快到自己都愣了一下。他很少这样对人说话。林晚被他吓得松了手。

叶无道转过身,第一次正面看她。塔的灯把他眉骨那道疤照得很深。

"你以为你没有可被收走的东西。"他说,"塔不这么算。它会从我这儿收。"

他没再解释,抬手按上镜子。冰冷的力顺着手臂爬上来,他闷哼一声,膝盖一软,却死死站住了。回廊尽头那团黑暗被他一拳轰开,碎成漫天的灰。

代价来得无声无息。他低头,发现自己想不起那一夜捅他的人的脸了——那张他恨了三年、发誓要亲手登顶改写的脸,被塔干干净净地收走了。

林晚扶住他,声音发颤:"你在乎的……是什么?"

叶无道没答。他只是觉得心里空了一块,空得他反而踏实。他把林晚往身后带了带,像每一次那样,挡在她和黑暗之间。
...
"走了。"他说,"别回头。"""
    ...
    r1 = lenses.narrate_commit(World_w1, t1, {
        ...
        "sediments": [
            {"entity": "ye-wudao", "text": "靠悖论破解第一层,没问林晚怎么看穿的就护她到身后", "level": "持久", "trace": "第1章"},
            {"entity": "lin-wan", "text": "第一次靠过目不忘救了场,觉得塔没那么冷了", "level": "身份", "trace": "第1章"},
            {"entity": "lu-jia", "text": "违规身亡", "level": "瞬时"},
        ],
        "state_updates": {"ye-wudao": {"location": "塔·第二层", "mood": "戒备", "goal": "活过这一层"},
    ...
    r2 = lenses.narrate_commit(World_w1, t1, {
        ...
        "sediments": [
            {"entity": "ye-wudao", "text": "为护林晚借塔外之力,代价是被收走了仇人的脸——心里空了反而踏实", "level": "身份", "trace": "第2章·成长时刻:违背执念护人"},
            {"entity": "lin-wan", "text": "看见他为自己付代价,第一次意识到他把她算作'最在乎'", "level": "身份", "trace": "第2章"},
        ],
        "state_updates": {"ye-wudao": {"location": "塔·第三层", "mood": "空而踏实", "goal": "继续登塔"},
                          "lin-wan": {"location": "塔·第三层", "mood": "动容"}},
        "beat": "第二层:代价律,叶无道护住林晚、丢了仇人的脸",
        "summary": "# 首登 · 摘要\n\n叶无道与林晚被同一人背叛后卷入无限之塔。第一层靠悖论破局(林晚过目不忘初显);第二层叶无道为护林晚借力,被塔收走仇人的脸。两人从互不交底到并肩。α 悬念『背后那一刀是谁』因代价被模糊,埋下更深的钩。",
    })
    ...
    lenses.play_commit(World_w1, t1, {
        ...
        "transcript": "林晚:你想不起他的脸了,会难过吗?\n叶无道:啧。少了张要恨的脸,睡得着觉。\n林晚:……那你现在最想守住的是什么?\n叶无道沉默了很久,把外套丢给她,没回答。",
        "growth": [{"entity": "lin-wan", "text": "试探他的在乎,得到一件外套作答", "trigger": False},
                   {"entity": "ye-wudao", "text": "用沉默和一件外套承认了答案", "trigger": True, "trace": "成长时刻:承认在乎"}],
    })
...
""")
    ...
    # ---------- L4 枢纽:跨世界穿梭 ----------
    nexus.ascend(World_w1, "ye-wudao")
    nexus.link_worlds("infinite-tower", "linjiang", "第七层裂隙通向临江", note="临江是塔的一层副本")
    nexus.summon("ye-wudao", w2, entry="换皮进")
    from sv.nexus import NexusEntity
    NexusEntity.load("ye-wudao").sediment("linjiang", "在临江以陌生身份醒来,雨夜里仍下意识把路人挡到身后", level="身份", where="cross-world")
    print("  叶无道:升格为跨世界实体 → 临江开化身(换皮进)")
